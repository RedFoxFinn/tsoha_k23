...
import modules.statistics_module as statistics
...
def stats():
    ...
    _stats = None
    if _user != None and _status in ["ADMIN","SUPER"]:
    ...
    _localized_stats = [(localized_fields[key],value) for (key,value) in _stats]
